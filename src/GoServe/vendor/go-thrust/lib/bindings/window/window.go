...
import (
	...
	// Switch to Vendoring
	//"GoServe/external/go-thrust-master/lib/bindings/session"
	//. "GoServe/external/go-thrust-master/lib/commands"
	//. "GoServe/external/go-thrust-master/lib/common"
	//"GoServe/external/go-thrust-master/lib/connection"
	//"GoServe/external/go-thrust-master/lib/dispatcher"
	//"GoServe/external/go-thrust-master/lib/events"
	//"GoServe/external/go-thrust-master/lib/spawn"
	"go-thrust/lib/bindings/session"
	. "go-thrust/lib/commands"
	. "go-thrust/lib/common"
	"go-thrust/lib/connection"
	"go-thrust/lib/dispatcher"
	"go-thrust/lib/events"
	"go-thrust/lib/spawn"
)
